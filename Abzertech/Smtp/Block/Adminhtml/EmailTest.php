...
class EmailTest extends Template
{
    ...
    protected function validateMagentoEmailSetting()
    {
        ...
        $this->dataHelper->setTestMode(true);
        $this->dataHelper->setStoreId($this->getStoreId());
        $this->dataHelper->setTestConfig($this->getConfig());
        ...
        $this->dataHelper->setTestMode(false);
    ...
    public function validateMagentoEmailStatus()
    {
        ...
        if ($this->dataHelper->getScopeConfigValue('abzer_smtp/smtp/disable')) {
            $result = $this->error(
                true,
